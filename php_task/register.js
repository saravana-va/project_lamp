function functionName()
{
  //member id validation 
    ...
    var mem_id = document.getElementById('id1').value;
    if (mem_id == "") {  document.getElementById('errors member_id').innerHTML="*Please enter the Member Id*";
                            
    return false;
	}
    if(isNaN(mem_id))
    {
    document.getElementById("errors member_id").innerHTML="*Please enter Number only*";
    return false;
    }
    document.getElementById("errors member_id").style.display="none";
