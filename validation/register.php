...
if(isset($_POST['Submit'])){
    ...
    include_once('phpValidation');
    $user_obj = new User($_POST);
    $errors = $user_obj->validate();
    if($errors[Flag] === true) {
        foreach($errors as $value) { 
            print_r("errorMessage :\t$value");
            echo "<br>";
    }
}
else {
        ...
        <form name="myForm" action = "register.php" method="POST">
            <div align="center">            
                ...
                <table class= "main_table">
                   <tr>
                        <td>Member_id</td>
                        <td> <input id="id1" type="number" name="Member_id" maxlength="30" placeholder="Member Id" 
                                    title="Enter Member Id" >
    	                    <div class="style1" id ="errors member_id"> </div>
                        </td>
                    </tr>
                    <tr>
                        <td>First Name </td>
                    ...
                    <tr>
                        <td>Password </td>
                        <td> <input id="password1"type="password" name="Password" minlength="1" maxlength="14"
                                placeholder="Password" title="Enter Password">
                        </td>
                    </tr>
                    <tr>
                        <td>Confirm Password </td>
                        <td> <input id="password2" type="password" name="confirm_password" minlength="1" maxlength="14" 
